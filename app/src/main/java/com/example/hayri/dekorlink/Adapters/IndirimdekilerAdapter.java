...
public class IndirimdekilerAdapter  extends RecyclerView.Adapter<IndirimdekilerAdapter.ViewHolder>{
    List<SoldprodactsItem> list;
    Context context;


    public IndirimdekilerAdapter(List<SoldprodactsItem> list, Context context) {
        this.list = list;
        this.context = context;
    }
    @NonNull
    @Override
    public IndirimdekilerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new IndirimdekilerAdapter.ViewHolder(view);
    }
